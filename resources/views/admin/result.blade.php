...
<div class="container">
	<div class="row">
		...
		<div class="col-md-8">
			...
			<div class="panel panel-info" style="margin-bottom: 20px" v-for="position in positions">
				<div class="panel-heading">@{{  position['POSITION']}}</div>
				<div class="panel-body">
					<div v-for="voteresult in voteresults" v-if="position['POSITION']==voteresult['POSITION']">
